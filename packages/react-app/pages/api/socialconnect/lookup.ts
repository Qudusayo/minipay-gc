...
import { DEK_PRIVATE_KEY, ISSUER_PRIVATE_KEY, RPC } from "@/utils/constants";
  ...
  switch (req.method) {
    case "GET":
      try {
        ...
        let wallet = new Wallet(ISSUER_PRIVATE_KEY!, provider);
        ...
        const identifier = (req.query.handle as string).trim(); // TODO typesafety
